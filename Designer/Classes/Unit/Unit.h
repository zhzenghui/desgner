...
#define SharedAppMainVC ((ZHAppDelegate *)[[UIApplication sharedApplication] delegate]).mainVC
...
#define kLongLongDuration 3

//#define KHomeUrl @"http://223.4.147.79:8080"
//#define KHomeUrl @"http://115.28.182.9:8080/"
//#define KHomeDomainUrl @"http://115.28.182.9/"


#define KHomeUrl @"http://designer-app.com:8080/"
#define KHomeDomainUrl @"http://designer-app.com/"
...
//     王阿平
#define kD_Id [[UserSettingInfo share] getValueForKey:@"kD_Id"]
