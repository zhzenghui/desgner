...
//        imageView.image = item.image;
        //添加标题栏
        UILabel * lbltitle = [[UILabel alloc] initWithFrame:CGRectMake(i * _scrollView.frame.size.width, _scrollView.frame.size.height-30.0, _scrollView.frame.size.width, 30)];
        lbltitle.text = item.title;
        lbltitle.textAlignment = NSTextAlignmentCenter;
        lbltitle.textColor = [UIColor whiteColor];
        lbltitle.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"黑条"]];
